 ...
 * 
 */
router.get('/cs/config', cache(3600), async (req, res) =>{
...
router.get('/cs/modes', cache(3600), async (req, res) =>{
...
router.get('/cs/statistic', cache(60),  async (req, res) =>{
...
router.get('/cs/tournaments', cache(3600), async (req, res) =>{
...
router.get('/cs/regions', cache(3600), async (req, res) =>{
...
router.get('/cs/leagues', cache(3600), async (req, res) =>{
...
router.get('/cs/streamers', cache(3600), async (req, res) =>{
...
router.get('/cs/servers', cache(3600), async (req, res) =>{
...
router.get('/cs/ranks', cache(3600), async (req, res) =>{
...
router.get('/cs/ladder', cache(3600), async (req, res) =>{
...
router.get('/cs/matches', cache(3600), async (req, res) =>{
...
router.get('/cs/player/:type/:id/info', cache(3600), async (req, res) =>{
...
router.get('/cs/player/:id/:limit/nicknames', cache(3600), async (req, res) =>{
